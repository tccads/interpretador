    ...
    public void initSheetView(int[][] boardMatrix, ViewData note) {
        ...
        for (int i = 2; i < boardMatrix.length; i++) {
            for (int j = 0; j < boardMatrix[i].length; j++) {
                Rectangle rectangle = new Rectangle(NOTE_SIZE, NOTE_SIZE);
        ...
        notePanel.setLayoutX(musicSheetPanel.getLayoutX() + note.getxPosition() * notePanel.getVgap() + note.getxPosition() * NOTE_SIZE);
        notePanel.setLayoutY(-42 + musicSheetPanel.getLayoutY() + note.getyPosition() * notePanel.getHgap() + note.getyPosition() * NOTE_SIZE);
